...
def recommend_similar_products(product_id, limit=6):
    ...
    try:
        ...
        # Product ke paas embedding nahi hai
        # to similarity search nahi karenge.
        #
        # New products ke liye embedding
        # models.product.create_product()
        # ke andar automatically generate hoti hai.
...
def recommend_collaborative(user_id, limit=6):
    ...
    try:
        ...
        # -------------------------------------------------
        # Current user ne kaunse products purchase kiye?
        # -------------------------------------------------
        ...
        # -------------------------------------------------
        # Similar users ke purchased products
        # -------------------------------------------------
